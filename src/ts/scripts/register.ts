...
const response = await fetch(url, {
    ...
    body: JSON.stringify(
        [
            ...
            AGENT_COMMAND, WENGINE_COMMAND, BANGBOO_COMMAND, SEND_ISSUE_COMMAND, QUOTE_COMMAND,
            QUOTE_ADD_COMMAND, QUOTEADD_COMMAND, QUOTE_DELETE_COMMAND, QUOTEDELETE_COMMAND
        ]
    ),
});
